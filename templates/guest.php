    ...
    <div class="container">
        ...
        <div class="content">
            <section class="welcome">
                <h2 class="welcome__heading">«CUP CUP PROJECT»</h2>

                <div class="welcome__text">
                    <p>«CUP CUP PROJECT» — это веб приложение для удобного контроля проектов. Сервис помогает пользователям не забывать о предстоящих важных событиях и задачах.</p>

                    <p>После создания аккаунта, пользователь может начать вносить свои проекты, распределяя задачи и указывать сроки.</p>
                </div>
